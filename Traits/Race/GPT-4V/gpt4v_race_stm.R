...
data = read.csv('../../../Data/GPT-4V/Race/study_1.csv') %>% 
...
kresult <- searchK(docs, 
                   ...
                   c(3:15), 
                   interactions = FALSE,
                   prevalence = ~race + proto + race * proto,
                   data = meta, 
                   cores = 4)
...
# save.image('gpt4v_race_stm.RData')
load('gpt4v_race_stm.RData')
...
set.seed(1048596)
summary(estimateEffect(c(1) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(2) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(3) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(4) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(5) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(6) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(7) ~ race, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(8) ~ race, fit, metadata = meta))

# Main effect of prototypicality -----------------------------------------------

set.seed(1048596)
summary(estimateEffect(c(1) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(2) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(3) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(4) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(5) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(6) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(7) ~ proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(8) ~ proto, fit, metadata = meta))

# Interaction effect -----------------------------------------------------------

set.seed(1048596)
summary(estimateEffect(c(1) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(2) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(3) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(4) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(5) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(6) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(7) ~ race * proto, fit, metadata = meta))

set.seed(1048596)
summary(estimateEffect(c(8) ~ race * proto, fit, metadata = meta))
