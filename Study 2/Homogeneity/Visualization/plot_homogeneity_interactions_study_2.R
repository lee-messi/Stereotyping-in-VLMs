...
load('../Mixed/homogeneity_study_2.RData')
...
ggplot(all_models, aes(x = proto, y = cosine, group = gender, color = gender)) + 
...
# Save plot
ggsave("../Visualization/homogeneity_interactions_study_2.pdf", 
